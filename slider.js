~function( NS ){
	...
	NS.Slider.prototype = {
		render : function render(){
			// create structure
			this.$node
				.append( '<div class="slider-bar" style="width:'+this.width+'px"></div>' )
		...
		, mouseMove : function mouseMove( ev ){
			...
			if( this.handleNm === 'right' ){
				...
				if ( range[1]-range[0] > maxDiff) {
                    range[0]=range[1]-maxDiff
                }
